...
import 'package:secondflutter/utilities/dialogs/password_root_email_sent_dialog.dart';
      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: Column(children: [
            const Text('enter email to sent a email reset password'),
            TextField(
              ...
              decoration:
                  const InputDecoration(hintText: 'Your email addres ....'),
            ),
            TextButton(
                onPressed: () {
